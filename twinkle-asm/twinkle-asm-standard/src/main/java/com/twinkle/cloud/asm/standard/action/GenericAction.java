...
public interface GenericAction<_P extends IParam, _V extends IVar> {
    ...
    /**
     *
     * Get {@code this} keyword as a variable, if current is a static com.twinkle.cloud.common.asm.block.method, will throw
     * com.twinkle.cloud.common.asm.block.exception while call this com.twinkle.cloud.common.asm.block.method.
     *
     * @return {@link _V}
     * @see #super_()
     */
     ...
     * this com.twinkle.cloud.common.asm.block.method is equivalence to :
     * <pre>
    ...
    /**
     * Get {@code super} keyword as a variable, if current is a static com.twinkle.cloud.common.asm.block.method, will throw
     * com.twinkle.cloud.common.asm.block.exception while call this com.twinkle.cloud.common.asm.block.method.
     *
     * @return {@link _V}
     * @see #this_()
    ...
    /**
     * Get field from current object. the com.twinkle.cloud.common.asm.block.method is same to call following :
     *
     * <pre>
     * this_().field(name);
     * </pre>
     ...
     * {@link ArithmeticAction#add(_P, _P)} com.twinkle.cloud.common.asm.block.method, that
    ...
    /**
     * Generate the instanceof instruction, the com.twinkle.cloud.common.asm.block.method is same as

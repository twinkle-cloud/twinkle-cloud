 ...
 */
package com.twinkle.cloud.asm.standard.def.method;

import com.twinkle.cloud.asm.standard.def.clazz.ClassHolder;
...
public class AMethodMeta implements Cloneable {
    ...
    /** The parameter type list of com.twinkle.cloud.common.asm.block.method */
    private Type[] argTypes;
    
    /** The parameter type list of com.twinkle.cloud.common.asm.block.method */
    private IClass[] argClasses;
    
    /** The parameter name list of com.twinkle.cloud.common.asm.block.method */
    private String[] argNames;
    
    /** The com.twinkle.cloud.common.asm.block.method return type */
    private Type returnType;
    
    /** The com.twinkle.cloud.common.asm.block.method modifier */
    ...
    public AMethodMeta(ClassHolder classHolder, String name, IClass owner, IClass actuallyOwner,
        ...
        if (argClasses.length != argNames.length) {
            throw new ASMSupportException(
                    "Different length between argClasses and argNames when create com.twinkle.cloud.common.asm.block.method : " + name);
        }

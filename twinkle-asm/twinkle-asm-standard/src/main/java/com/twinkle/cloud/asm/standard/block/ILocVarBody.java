...
/**
 * Indicate a program com.twinkle.cloud.common.asm.block, it's will be passes an local variable (is the sub type of
...
public interface ILocVarBody<_Var extends ILocVar> extends IBody {
    ...
    /**
     * enter a program com.twinkle.cloud.common.asm.block with a local variable.
     * 
     * @param e
     */
    void body(_Var e);

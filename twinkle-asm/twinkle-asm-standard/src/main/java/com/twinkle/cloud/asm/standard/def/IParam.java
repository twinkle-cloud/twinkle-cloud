 ...
 */
package com.twinkle.cloud.asm.standard.def;

import com.twinkle.cloud.asm.standard.def.clazz.IClass;
import com.twinkle.cloud.asm.standard.def.var.IFieldVar;

/**
 * The interface indicate a operand among operator, such as a variable, a constant, 
 * a com.twinkle.cloud.common.asm.block.method invoke or arithmetic operator and so on.
 * 
 * @author sqwen
 */

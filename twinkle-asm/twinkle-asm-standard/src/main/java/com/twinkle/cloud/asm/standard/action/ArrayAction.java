...
/**
 * The array com.twinkle.cloud.common.asm.action set.
 *
 *
...
public interface ArrayAction<_P extends IParam> {
	...
	/**
     * <p>
     * Make an empty array value according an array type and the length of each dimensions call this com.twinkle.cloud.common.asm.block.method is seem like to
     * following java code :
     * </p>
     * 
     * 
     ...
     * {@link cn.wensiqun.asmsupport.standard.def.IParam}, call this com.twinkle.cloud.common.asm.block.method is seem like to
     * following java code :
     * </p>
     * 
     * <p style="border:1px solid;width:550px;padding:10px;">
     ...
     * 
     * <p>
     * Get array element according arguments. call this com.twinkle.cloud.common.asm.block.method is seem like to
     * following java code :
     * </p>
     * 
     ...
     * 
     * <p>
     * Set element value to array according argument. call this com.twinkle.cloud.common.asm.block.method is seem like to
     * following java code :
     * </p>
     * 
     * <p style="border:1px solid;width:400px;padding:10px;">
    ...
    /**
     * Get array length, call this com.twinkle.cloud.common.asm.block.method is seem like to
     * following java code : 
     * 

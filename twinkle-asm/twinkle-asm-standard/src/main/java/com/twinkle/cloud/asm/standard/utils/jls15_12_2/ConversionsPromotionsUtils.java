...
import com.twinkle.cloud.asm.standard.utils.IClassUtils;
import com.twinkle.cloud.asm.standard.def.clazz.IClass;
import org.springframework.asm.Type;

/**
 * Support conversions and promotions according chapter 5 of com.twinkle.cloud.common.asm.utils.jls.
 * 
 */
public class ConversionsPromotionsUtils {
     ...
     * 
     * </p>Widening reference conversions never require a special com.twinkle.cloud.common.asm.action at run time and
     * therefore never throw an com.twinkle.cloud.common.asm.block.exception at run time. They consist simply in regarding

...
import com.twinkle.cloud.common.utils.reflect.criteria.PropertyCriteria;
import com.twinkle.cloud.common.utils.reflect.criteria.PropertyCriteriaFactory;
...
public class ReflectionUtils {
    ...
    public static Object invokeMethod(final Object obj, final String methodName, final Class<?>[] parameterTypes,
        ...
        if (method == null) {
            throw new IllegalArgumentException("Could not find com.twinkle.cloud.common.asm.block.method [" + methodName + "] on target [" + obj + "]");
        }
     ...
     *
     * @param clazz com.twinkle.cloud.common.asm.def.clazz The class to introspect
    ...
    /**
     * 将反射时的checked exception转换为unchecked com.twinkle.cloud.common.asm.block.exception.
     */

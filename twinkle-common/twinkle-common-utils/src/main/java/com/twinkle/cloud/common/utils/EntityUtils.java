...
import com.twinkle.cloud.common.utils.reflect.ReflectionUtils;
...
public class EntityUtils {
    ...
    public static <T> void setCreateInfo(T entity) {
        ...
        String id = "";
        if (request != null) {
            hostIp = StringUtils.defaultIfBlank(request.getHeader("userHost"), ClientUtils.getClientIp(request));

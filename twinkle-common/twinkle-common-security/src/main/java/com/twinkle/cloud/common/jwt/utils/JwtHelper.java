package com.twinkle.cloud.common.jwt.utils;
...
public class JwtHelper {
    ...
    public static String generateToken(IJwtInfo jwtInfo, String priKeyPath, int expire) throws Exception {
        String compactJws = Jwts.builder()
                ...
                .claim(SecurityConstant.JWT_KEY_USER_ID, jwtInfo.getId())
                .claim(SecurityConstant.JWT_KEY_NAME, jwtInfo.getName())
    ...
    public static IJwtInfo getInfoFromToken(String token, String pubKeyPath) throws Exception {
        ...
        return new JwtInfo(body.getSubject(), StringHelper.getObjectValue(body.get(SecurityConstant.JWT_KEY_USER_ID)), StringHelper.getObjectValue(body.get(SecurityConstant.JWT_KEY_NAME)));
    }
    /**
     * 获取token中的用户信息
     *

...
@Configuration
@Slf4j
@ConditionalOnProperty(value = "twinkle.bus.receiver.enable",havingValue = "true")
public class ReceiverBusConfig {

    @Value("${twinkle.bus.receiver.exchange-name}")
    private String EXCHANGE_NAME = "spring-boot-exchange";
    @Value("${twinkle.bus.receiver.routing-key}")
    private String ROUTING_KEY = "gateway-route";

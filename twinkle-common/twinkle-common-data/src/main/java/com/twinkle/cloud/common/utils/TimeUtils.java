...
//    	System.out.println(time);
    ...
    public int get(int field) {
        if(field < 0 || field > fields.length - 1) {
            throw new IllegalArgumentException(field + ", field value is com.twinkle.cloud.common.asm.error.");
        }
        return fields[field];
    }
    ...
    private void parseTimeException(String time) {
        throw new IllegalArgumentException(time + ", time format com.twinkle.cloud.common.asm.error, HH"

package com.twinkle.cloud.security.authorization.constants;
 ...
 */
@Getter
public enum OAuth2ErrorType implements ErrorType {
    ...
    private OAuth2ErrorType(String _code, String _message) {
        this.code = _code;
